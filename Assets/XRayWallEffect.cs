...
public class XRayWallEffect : MonoBehaviour
{
    ...
    void SetupSilhouetteMaterial()
    {
        if (silhouetteMaterial != null)
        {
            ...
            silhouetteMaterial.SetInt("_ZTestDepthEqualForOpaque", (int)UnityEngine.Rendering.CompareFunction.Always);
    ...
    void CheckIfBehindWall()
    {
        ...
        // Duvar tespiti
        RaycastHit hit;
        if (Physics.Raycast(mainCamera.transform.position, directionToPlayer.normalized, out hit, distance, wallLayer))
        {
