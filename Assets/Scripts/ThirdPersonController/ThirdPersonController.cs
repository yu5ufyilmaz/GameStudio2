...
namespace DotGalacticos
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        public void Dying()
        {
            // Eğer video oynatılıyorsa, bu metod kullanılmayacak
            // Çünkü onVideoFinished metodu videodan sonra sahne geçişini yapacak
            
            // Video yoksa veya çalınamıyorsa doğrudan sahne geçişi yap
            if (videoPlayer == null)
            {
                SceneManager.LoadScene("StartMenu");
                Cursor.visible = true;
